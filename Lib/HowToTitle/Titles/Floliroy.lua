...
HTT:RegisterTitle("@Panaa", nil, 92, {en = "|c0000CDTormen|r|cFFFFFFted By Ti|r|cFF0000ck Tock|r", fr = "|c4169E1 Le Handicap Est Ma Passion|r", de = "|cFFFF00Ich mag Schokoladen Kuchen|r"})
HTT:RegisterTitle("@Panaa", nil, 2136, {en = "|c0000CDBag|r|cFFFFFFuet|r|cFF0000te!|r"})
...
-- Stress Tested
HTT:RegisterTitle("@Valencer", nil, true, {en = "|cff99ccCutiepie|r |ccc0000<3|r"}, {hidden = true})
...
HTT:RegisterTitle("@imidazole", nil, true, {en = "|c66ff99Delivery|r |c3399ffService"}, {hidden = true})
HTT:RegisterTitle("@elfoblin", nil, true, {en = "|cffcc99Calm|r |cffcc99Down|r |cff99ccValen|r :3"}, {hidden = true})
...
--Det Frie Folk
HTT:RegisterTitle("@Donlup", nil, true, {en = "|ccc0000P|r|ccc4400T|r|cff7733S|r|cffcc00Donlup|r"}, {hidden = true})
...
HTT:RegisterTitle("@Berthelsen21", nil, true, {en = "|c1a6600  En|r |cffffff |r |c002db3To |r |cffffff|r |ccca300Ørkensten|r"}, {hidden = true})
HTT:RegisterTitle("@Skinfaxe_DK", nil, true, {en = "Kadaverklat"}, {color={"#CC6699", "#CC33FF"}, hidden = true})

--Others
HTT:RegisterTitle("@YungDoggo", nil, 2746, {en = "|cffffffA|r|cfff0ffl|r|cffe8ffm|r|cffe0ffi|r|cffd9ffg|r|cffc9ffh|r|cffc2fft|r|cffbaffy|r |cffa3ffW|r|cff9cffe|r|cff7dffe|r|cff66ffb|r"})
...
--test @Skinfaxe_DK
-- HTT:RegisterTitle("@nogetrandom", nil, 92, {en = ""}, {color={"#", "#"}})
